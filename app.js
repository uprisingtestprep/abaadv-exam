/* ABAADV Exam Simulator, Application Logic */

const ACCESS_CODE  = "ABAADV9000";
const EXAM_SECONDS = 14400;
const PASSING_PCT  = 70;
const STORAGE_KEY  = "abaadv_exam_state_v1";
...
const DOMAIN_LABELS = {"basic_sciences": "Basic Sciences", "clinical_sciences": "Clinical Sciences", "organ_based_sciences": "Organ-Based Sciences", "clinical_subspecialties": "Clinical Subspecialties", "special_problems_in_anesthesiology": "Special Problems in Anesthesiology"};  // maps domain key -> human-readable label for display
